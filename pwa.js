...
const cacheName = 'SYSunagawaA3-2021-03-13 23:03:56.883430'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'SYSunagawaA3'.length) === 'SYSunagawaA3') {
